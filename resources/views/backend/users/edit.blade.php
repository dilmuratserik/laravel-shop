      ...
      <form method="post" action="{{route('users.update',$user->id)}}">
        ...
        @method('PATCH')
          <div class="form-group">
              ...
              <input id="inputTitle" type="text" name="name" placeholder="Enter name"  value="{{old('first_name')}}" class="form-control">
              @error('first_name')
          ...
          <div class="form-group">
              ...
              <input id="inputTitle" type="text" name="name" placeholder="Enter name"  value="{{old('last_name')}}" class="form-control">
              @error('last_name')
              <span class="text-danger">{{$message}}</span>
              @enderror
          </div>
