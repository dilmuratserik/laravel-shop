                   ...
                   <div class="col-md-4">
                       <div class="card">
                           ...
                           <div class="card-body mt-4 ml-2">
                               <h5 class="card-title text-left"><small><i class="fas fa-user"></i> {{$profile->first_name . $profile->last_name}}</small></h5>
                   ...
                   <div class="col-md-8">
                       <form class="border px-4 pt-2 pb-3" method="POST" action="{{route('profile-update',$profile->id)}}">
                           ...
                           <div class="form-group">
                               ...
                               <input id="inputTitle" type="text" name="name" placeholder="Enter first name"  value="{{$profile->first_name}}" class="form-control">
                               @error('last_name')
                           ...
                           <div class="form-group">
                               ...
                               <input id="inputTitle" type="text" name="name" placeholder="Enter last name"  value="{{$profile->last_name}}" class="form-control">
                               @error('first_name')
                               <span class="text-danger">{{$message}}</span>
                               @enderror
                           </div>
