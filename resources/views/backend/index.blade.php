            ...
            <div class="row">
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-info">
                        <div class="inner">
                            <h3>{{\App\Models\Category::countActiveCategory()}}</h3>
                            <p>Category</p>
                        </div>
                        <div class="icon">
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-success">
                        <div class="inner">
                            <h3>{{\App\Models\Product::countActiveProduct()}}</h3>
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-warning"><div class="inner">
                            <h3>{{\App\Models\Order::countActiveOrder()}}</h3>
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-danger">
                        <div class="inner">
                            <h3>{{\App\Models\Post::countActivePost()}}</h3>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            <h6 class="m-0 font-weight-bold text-black">Earnings Overview</h6>
                ...
                <div class="col-md-6">
                    <div class="card shadow mb-4">
                        <!-- Card Header - Dropdown -->
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            <h6 class="m-0 font-weight-bold text-black">Users</h6>
                        </div>
                        <!-- Card Body -->
