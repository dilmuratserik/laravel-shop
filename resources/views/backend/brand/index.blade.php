 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary float-left">Brand List</h6>
        <a class="btn btn-primary btn-sm float-right " style="margin-left:5px;"data-toogle='tooltip' data-placement="bottom" href="{{route('brand.export')}}">Export</a>
        <a class="btn btn-primary btn-sm float-right " style="margin-left:5px;"data-toogle='tooltip' data-placement="bottom" href="">Import</a>
        <a href="{{route('brand.create')}}" class="btn btn-primary btn-sm float-right" style="margin-left:5px;" data-toggle="tooltip" data-placement="bottom" title="Add User"><i class="fas fa-plus"></i> Add Brand</a>
    </div>
    <div class="card-body">
